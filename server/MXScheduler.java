/**
* Max-Min scheduler - assigns jobs to processors in batches, by first sorting the tasks in decending order then using an 
...
public class MXScheduler extends SchedulerCommon implements NewSchedulingAlgorithm  {
		//constructor
		public MXScheduler() {}
		...
		*/
		public void generateSchedule(Vector batch) {
			...
			try {
					estFinishingTime();
					batch =  sortTasksDecending(batch);
					...
					System.out.println("Error in generateSchedule -> "+ e);
				}
		}
	}
